...
<div id="content">
	...
	<table class="compaingTable" summary="월별통계 리포트">
		...
		<tr>
				<td><a href="/statistics/periodStatistics/month?search_type=month&start_dt=<?php echo $statistics_vo->get_division_dt(); ?>-01-01&end_dt=<?php echo $statistics_vo->get_division_dt(); ?>-12-31"><?php echo $statistics_vo->get_division_dt(); ?></a></td>
	...
	<div class="exelDown">
			<em>※ 모든 지표를 연도별 기준으로 산출하여 위 데이터를 제공합니다.</em>
			<a href="/statistics/periodStatistics/excel?search_type=year"><img src="../../web/images/button/excel_btn33.png" alt="엑셀 다운로드"></a>
	</div>
</div>