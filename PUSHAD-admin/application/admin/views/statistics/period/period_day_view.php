...
<div id="content">
	...
	<div class="exelDown">
		<em>※ 선택한 기간에 속하는 지표를 일별 기준으로 산출하여 위 데이터를 제공합니다.</em>
		<a href="/statistics/periodStatistics/excel?search_type=day&start_dt=<?php echo $start_dt?>&end_dt=<?php echo $end_dt?>"><img src="../../web/images/button/excel_btn33.png" alt="엑셀 다운로드"></a>
	</div>
	</form>
</div>